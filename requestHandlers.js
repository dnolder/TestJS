...
function execls(response) {
    console.log("Request handler 'start' was called.");
    exec("ls -lah /tmp/test.png", function (error, stdout, stderr) {
...
function fileupload(response, request) {
    console.log("Request handler 'fileupload' was called.");
...
exports.textstart = textstart;
exports.filestart = filestart;
